  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusNoElasticApp.project.home.createOrEditLabel">
            <Translate contentKey="localizeusNoElasticApp.project.home.createOrEditLabel">Create or edit a Project</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : projectEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="project-name">
                  <Translate contentKey="localizeusNoElasticApp.project.name">Name</Translate>
                </Label>
