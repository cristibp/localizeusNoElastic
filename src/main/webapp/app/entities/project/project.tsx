  ...
  return (
    <div>
      <h2 id="project-heading">
        <Translate contentKey="localizeusNoElasticApp.project.home.title">Projects</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusNoElasticApp.project.home.createLabel">Create new Project</Translate>
        </Link>
      </h2>
        ...
        {projectList && projectList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="localizeusNoElasticApp.project.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusNoElasticApp.project.home.notFound">No Projects found</Translate>
            </div>
          )
        )}
      </div>
