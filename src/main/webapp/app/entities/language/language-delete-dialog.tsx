...
export const LanguageDeleteDialog = (props: ILanguageDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusNoElasticApp.language.delete.question">
        <Translate contentKey="localizeusNoElasticApp.language.delete.question" interpolate={{ id: languageEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-language" color="danger" onClick={confirmDelete}>
