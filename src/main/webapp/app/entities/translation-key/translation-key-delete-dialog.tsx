...
import { getEntity, deleteEntity } from './translation-key.reducer';
...
export const TranslationKeyDeleteDialog = (props: ITranslationKeyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusNoElasticApp.translationKey.delete.question">
        <Translate contentKey="localizeusNoElasticApp.translationKey.delete.question" interpolate={{ id: translationKeyEntity.id }}>
