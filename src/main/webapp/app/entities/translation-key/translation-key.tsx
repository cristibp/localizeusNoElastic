  ...
  return (
    <div>
      <h2 id="translation-key-heading">
        <Translate contentKey="localizeusNoElasticApp.translationKey.home.title">Translation Keys</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusNoElasticApp.translationKey.home.createLabel">Create new Translation Key</Translate>
        </Link>
      </h2>
        ...
        {translationKeyList && translationKeyList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="localizeusNoElasticApp.translationKey.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusNoElasticApp.translationKey.home.notFound">No Translation Keys found</Translate>
            </div>
          )
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TranslationKey);
