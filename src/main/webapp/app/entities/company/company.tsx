  ...
  return (
    <div>
      <h2 id="company-heading">
        <Translate contentKey="localizeusNoElasticApp.company.home.title">Companies</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusNoElasticApp.company.home.createLabel">Create new Company</Translate>
        </Link>
      </h2>
        ...
        {companyList && companyList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="localizeusNoElasticApp.company.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="localizeusNoElasticApp.company.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('phone')}>
                  <Translate contentKey="localizeusNoElasticApp.company.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusNoElasticApp.company.home.notFound">No Companies found</Translate>
            </div>
          )
        )}
      </div>
