...
export const CompanyDeleteDialog = (props: ICompanyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusNoElasticApp.company.delete.question">
        <Translate contentKey="localizeusNoElasticApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
