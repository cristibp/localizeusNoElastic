...
export const CommentDeleteDialog = (props: ICommentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusNoElasticApp.comment.delete.question">
        <Translate contentKey="localizeusNoElasticApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
