...
export const TransactionDeleteDialog = (props: ITransactionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusNoElasticApp.transaction.delete.question">
        <Translate contentKey="localizeusNoElasticApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
