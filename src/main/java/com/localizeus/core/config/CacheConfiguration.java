...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("localizeusNoElastic");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("localizeusNoElastic");
        ...
        config.getMapConfigs().put("com.localizeus.core.domain.*", initializeDomainMapConfig(jHipsterProperties));
