...
/**
 * REST controller for managing {@link com.localizeus.core.domain.Discussion}.
 */
@RestController
@RequestMapping("/api")
public class DiscussionResource {
    ...
    public ResponseEntity<DiscussionDTO> updateDiscussion(@RequestBody DiscussionDTO discussionDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, discussionDTO.getId().toString()))
            .body(result);
    }
