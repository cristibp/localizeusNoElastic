...
export class CompanyDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusNoElasticApp.company.delete.question'));
...
export default class CompanyComponentsPage {
  ...
  async deleteCompany() {
    ...
    expect(await companyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusNoElasticApp.company.delete.question/);
