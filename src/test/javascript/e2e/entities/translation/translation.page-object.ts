...
export class TranslationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusNoElasticApp.translation.delete.question'));
...
export default class TranslationComponentsPage {
  ...
  async deleteTranslation() {
    ...
    expect(await translationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(
      /localizeusNoElasticApp.translation.delete.question/
    );
