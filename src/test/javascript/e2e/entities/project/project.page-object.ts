...
export class ProjectDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusNoElasticApp.project.delete.question'));
...
export default class ProjectComponentsPage {
  ...
  async deleteProject() {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusNoElasticApp.project.delete.question/);
