...
export class CommentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusNoElasticApp.comment.delete.question'));
...
export default class CommentComponentsPage {
  ...
  async deleteComment() {
    ...
    expect(await commentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusNoElasticApp.comment.delete.question/);
